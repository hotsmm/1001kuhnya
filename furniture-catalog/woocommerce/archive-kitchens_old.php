	...
	<div class="container"> <!-- container/container-fluid -->
		<div class="row justify-content-center align-items-center" style="min-height: 50vh;"> <!-- min-height: 75vh; -->
			<div class="col text-light py-5"> <!-- text-center -->
				<!-- Title -->
				<h1 class="text-uppercase text-center fw-bold mb-2">Кухни в Рязани</h1>
				<!-- Subtitle -->
				<h2 class="text-center fw-normal mb-4">Готовые и на заказ по Вашим размерам</h2>
				<div class="row py-2 mb-4">
					...
					<div class="col-md-6 col-lg-3 mb-3 mb-md-0">
						<div class="row align-items-center gx-3 gx-md-0">
							<div class="col-2 col-md-3">
								<img src="<?php echo get_template_directory_uri(); ?>/images/icons/header-advantage-3.png" class="img-fluid">
							</div>
							<div class="col-10 col-md-9">
								<h3 class="text-light mb-0">Собственное производство</h3>
								<p class="text-light mb-0">С гарантией 2 года</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-lg-3 mb-0">
						<div class="row align-items-center gx-3 gx-md-0">
							<div class="col-2 col-md-3">
								<img src="<?php echo get_template_directory_uri(); ?>/images/icons/header-advantage-4.png" class="img-fluid">
							</div>
							<div class="col-10 col-md-9">
								<h3 class="text-light mb-0">Скидки до 50%</h3>
								<p class="text-light mb-0">И бытовая техника в подарок!</p>
							</div>
						</div>
					</div>
				</div>
				<p class="header-description text-center mb-4">Рассчитайте точную стоимость кухни прямо сейчас за 10 минут.</p>
...
<section class="shkafy-cupe-section site-section bg-light pt-5 pb-3">
	<div class="container">
		<div class="row">
			<div class="col">
				...
				<p class="section-sutitle text-center mb-4">Выбирайте из нашего каталога или присылайте свои проекты!</p>
			</div>
		</div>
		<div class="row">
			<div class="col project-entry">
				<ul class="nav justify-content-center product-menu" style="margin-bottom: 35px;">
					<?php				
						...
						if ( $parent ) {
							...
							//$cat_name = $obj->name;
							//$cat_id = $obj->term_id;
							//echo '<a href="'.get_category_link( $parent_id ).'" class="nav-link ps-0">Все '.$parent.'</a>';
							echo '<li class="nav-item"><a class="nav-link" aria-current="page" href="'.get_category_link( $parent_id ).'">Все '.$parent.'</a></li>';
							...
							foreach ( $terms as $term ) { ?>
								<li class="nav-item <?php echo $term->name; ?>">
									<a href="<?php echo get_category_link( $term->term_id ); ?>" class="nav-link<?php if ( is_product_category( $term->name ) ) echo ' active'; ?>"><?php echo $term->name; ?></a>
								</li>
							<?php }wp_reset_query();
						...
						// Если нет родителя, то ...
							...
							$cat_name = $obj->name;
							$cat_id = $obj->term_id;
							//echo '<a href="'.get_category_link( $cat_id ).'" class="nav-link ps-0">Все '.$cat_name.'</a>';
							echo '<li class="nav-item"><a class="nav-link active" aria-current="page" href="'.get_category_link( $cat_id ).'">Все '.$cat_name.'</a></li>';
							...
							foreach ( $terms as $term ) { ?>
								<li class="nav-item"><a class="nav-link" aria-current="page" href="<?php echo get_category_link( $term->term_id ); ?>"><?php echo $term->name; ?></a></li>
							<?php  }  wp_reset_query();
						} wp_reset_query();
					?>
				</ul>
...
<section class="order-section bg-white">
	<div class="order-section-img d-none d-md-block" style="background: url(https://xn----7sbabmjsi2adq8pnb.xn--p1ai/wp-content/themes/ladya/img/order-img-1.jpg) center; background-size: cover; right: 0%; left: 50%;"></div>
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-6">
				<img src="https://xn----7sbabmjsi2adq8pnb.xn--p1ai/wp-content/themes/ladya/img/order-img-1.jpg" class="img-fluid d-md-none">
			</div>
		</div>
	</div>
</section>
