...
<!-- Header parallax --
<header class="shkafy-cupe-header header-parallax">
	<div class="parallax-2"></div>
	<div class="container"> <!-- container/container-fluid --
		<div class="row justify-content-center align-items-center" style="min-height: 50vh;"> <!-- min-height: 75vh; --
			<div class="col-xxl-9 text-center text-light py-5"> <!-- text-center --
				<!-- Title --
				...
				<!-- Description --
				<p class="header-description fw-light mb-4">Готовые и на заказ по Вашим размерам.<br>Собственное производство из любых современных материалов.<br>Рассчитайте точную стоимость шкафа-купе прямо сейчас за 10 минут.</p>
				<button class="btn btn-lg btn-corporation-orange px-3 text-light" data-bs-toggle="modal" data-bs-target="#quizModal">Рассчитать стоимость</button>
			</div>
		</div>
	</div>
</header>
	...
	<div class="container"> <!-- container/container-fluid -->
		<div class="row justify-content-center align-items-center" style="min-height: 50vh;"> <!-- min-height: 75vh; -->
			<div class="col text-light py-5"> <!-- text-center -->
				<!-- Title -->
				<h1 class="text-uppercase text-center fw-bold mb-2">Купить шкаф в Рязани</h1>
				<!-- Subtitle -->
				<h2 class="text-center fw-normal mb-4">Готовый или на заказ по индивидуальным размерам</h2>
					...
					<div class="col-md-6 col-lg-3 mb-0">
						<div class="row align-items-center gx-3 gx-md-0">
							...
							<div class="col-10 col-md-9">
								...
								<p class="text-light mb-0">И ценные подарки!</p>
							</div>
						</div>
					</div>
				</div>
				<p class="header-description text-center mb-4">Рассчитайте стоимость шкафа прямо сейчас за 10 минут.</p>
...
<section class="shkafy-cupe-section site-section bg-white pt-5 pb-3">
<!-- Portfolio -->
	
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="text-uppercase text-center text-corporation-orange fw-bold">Каталог проектов</h2>
					<p class="section-description mb-4">Вы можете выбрать один из наших проектов или предложить свой!</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 project-entry">
						...
						if ( woocommerce_product_loop() ) {
							...
							if ( wc_get_loop_prop( 'total' ) ) {
								...
								while ( have_posts() ) { the_post();
									...
									wc_get_template_part( 'content', 'product-shkafy-cupe' );
			...
			<div class="col">
				...
				<div class="row justify-content-around">
					...
					<div class="col-md-6 mt-5">
						...
						<p class="fs-5 fw-light"><strong>Дополнительная скидка&#160;5%</strong> за 100% предоплату, молодожёнам и новосёлам, иногородним, пенсионерам, в день рождения и юбилей.</p>
					</div>
					<div class="col-md-6 mt-5">
