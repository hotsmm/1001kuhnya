...
<section class="contacts-section text-light">
					...
					<div class="col-md-4 pb-5 order-md-2">
						<ul style="list-style: none; padding-left: 0;">
							<li class="mb-3">
								...
								<li class="mb-3">
									<i class="fa-solid fa-phone fs-5 text-corporation-orange" style="min-width: 25px; position: relative; top: 3px;"></i> Телефон (отдел продаж): <a href="tel:84912255869" class="text-light">8 (4912) 25-58-69</a>
								</li>
							<li class="mb-3"><i class="fa-solid fa-phone fs-5 text-corporation-orange" style="min-width: 25px; position: relative; top: 3px;"></i> Телефон (отдел продаж): <a href="tel:89537308590" class="text-light">8 (953) 730-85-90</a></li>
							<li class="mb-3"><i class="fa-solid fa-phone fs-5 text-corporation-orange" style="min-width: 25px; position: relative; top: 3px;"></i> Телефон (управляющий): <a href="tel:84912283946" class="text-light">8 (4912) 28-39-46</a></li>
							<li class="mb-3">
								<i class="fas fa-envelope fs-5 text-corporation-orange" style="min-width: 25px;"></i> Email: <a href="mailto:1001_1@bk.ru" class="text-light">1001_1@bk.ru</a>
							</li>
							<li class="mb-3"><i class="fab fa-vk fs-5 text-corporation-orange" style="min-width: 25px;"></i> Вконтакте: <a href="https://vk.com/public205268139" class="text-light">vk.com/public205268139</a></li>
							<li><i class="fab fa-instagram fs-5 text-corporation-orange" style="min-width: 25px;"></i> Инстаграм: <a href="https://instagram.com/1001kuhnya?igshid=2mcmhikbs8t4" class="text-light">https://instagram.com/1001kuhnya</a></li>
						</ul>
	...
	<footer class="container py-3">
		<div class="row">
			<div class="col">
				<p class="m-0 text-center fw-light"> &#169;2023 <a href="https://сайт100.рф" class="text-light fw-light text-decoration-none">Мебельный магазин <strong>1001 и 1 кухня</strong></a></p>
				<p class="m-0 fs-075 text-center fw-light">Создание и продвижение сайта: <a href="https://сайт100.рф" class="text-light fw-light text-decoration-none">сайт<span class="text-danger">100</span>.рф</a></p>
			</div>
		</div>
	</footer>
</section>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body py-4 px-3">
						<div class="row justify-content-center">
							<div class="col-md-8">
								<form method="post" action="<?php echo get_template_directory_uri(); ?>/mails/get-price-mail.php">
									<input name="name" type="text" class="form-control mb-3" placeholder="Ваше имя" aria-label="Recipient's username" aria-describedby="button-addon2">
